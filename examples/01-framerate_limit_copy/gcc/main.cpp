...
void register_events()
{
	...
	// reshade::register_event<reshade::addon_event::present>(reinterpret_cast<void *>(on_present));
	// using present_callback_t = typename reshade::addon_event_traits<reshade::addon_event::present>::decl;
	// reshade::register_event<reshade::addon_event::present>(static_cast<present_callback_t>(on_present));
}
...
void unregister_events()
{
	...
	// reshade::unregister_event<reshade::addon_event::present>(reinterpret_cast<void *>(on_present));
	// using present_callback_t = typename reshade::addon_event_traits<reshade::addon_event::present>::decl;
	// reshade::unregister_event<reshade::addon_event::present>(static_cast<present_callback_t>(on_present));
}
